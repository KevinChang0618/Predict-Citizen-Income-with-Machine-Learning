...
# test
#knn(scale(xtrain), scale(data.frame("age"=52, "workclass"=5, "fnlwgt"=209642, "eduaction"=12,
...
- In KNN method, we use relationship, eduaction, capital_gain, occupation, capital_loss, hours_per_week, age, sex, marital_status, workclass, fnlwgt, and race 12 predictors to build our KNN model. We find that K= 36 has the lowest classification error rate 17.8%.
